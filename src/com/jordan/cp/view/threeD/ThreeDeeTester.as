package com.jordan.cp.view.threeD 
{
	 ...
	 * @author nelson.shin
	 */
	public class ThreeDeeTester extends Sprite 
	{
		...
		public static const CAM_Z : Number = 0;//-360;
		...
		//
		//-----------------------------------------------------
		public function ThreeDeeTester()
		{
			setup3D();
		}
...
//cube.rotationZ = 10;
			...
			var axis : Trident = new Trident(Math.max(50, 50), true);
//			axis.rotationX = 15;
//			axis.rotationY = 15;
//			axis.rotationZ = 15;
