package com.jordan.cp.view.summary {
	...
	extends DisplayContainer 
	{
		...
		protected static var ICON_Y							: uint = 0;
		//----------------------------------------------------------------------------
		// public variables
		//----------------------------------------------------------------------------
		...
		// constructor
		//----------------------------------------------------------------------------
		public function SummaryBuyButton() 
		{
			super();
		}
		...
		{
			icon = MovieClip( AssetManager.gi.getAsset( 'BuyTheShoesAsset', SiteConstants.ASSETS_ID ) );
			icon.x = ICON_X;
			icon.y = ICON_Y;
			addChild( icon );
		}
		...
		{
			TrackingManager.gi.trackCustom(TrackingConstants.RESOLVE_BUY_NOW );
